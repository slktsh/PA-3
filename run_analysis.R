...
names<-c("subject", "activities", names_mean, names_std) # the same for the names
...
tbl_s4<-arrange(tbl, subject, activities) 
...
names(tbl_s5)<-c("subject-ID", "activity-ID", new_names) 
